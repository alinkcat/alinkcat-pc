...
/// Lightweight lunar-calendar conversion for 1900–2100, with no external dependencies.
///
/// Data-table encoding (each u32 represents one year):
///   bits 0–3: leap-month number (0 means no leap month)
///   bit 16: whether the leap month has 30 days; otherwise 29
///   bits 15–3: whether months 1–12 have 30 days; otherwise 29
...
/// Lunar date information, serializable for frontend rendering.
#[derive(Debug, Clone, Serialize)]
pub struct LunarInfo {
    /// Solar date, "YYYY-MM-DD"
    pub solar: String,
    /// Sexagenary-cycle year, such as "Bingwu"
    #[serde(rename = "lunarYear")]
    pub lunar_year: String,
    /// Lunar month, such as "sixth month"; leap months use "leap sixth month"
    #[serde(rename = "lunarMonth")]
    pub lunar_month: String,
    /// Lunar day, such as "day 22"
    #[serde(rename = "lunarDay")]
    pub lunar_day: String,
    /// Full lunar date string, such as "Bingwu year, leap sixth month, day 22"
    pub lunar: String,
...
/// Convert a solar date to a lunar date (1900–2100).
...
/// Get lunar information for a solar date; defaults to today when omitted.
...
/// Get the weekday name for a solar date, such as "Monday".
...
mod tests {
    ...
    #[test]
    fn known_dates() {
        assert_lunar(2024, 2, 10, "甲辰", "正月", "初一"); // 2024 Spring Festival
        assert_lunar(2023, 1, 22, "癸卯", "正月", "初一"); // 2023 Spring Festival
        assert_lunar(2000, 2, 5, "庚辰", "正月", "初一"); // 2000 Spring Festival
        assert_lunar(1949, 10, 1, "己丑", "八月", "初十"); // Founding ceremony of the People's Republic of China
        assert_lunar(2023, 9, 29, "癸卯", "八月", "十五"); // 2023 Mid-Autumn Festival
    }

    #[test]
    fn leap_month() {
        // 2023 leap second month; 2023-03-23 ≈ lunar leap-month day two
