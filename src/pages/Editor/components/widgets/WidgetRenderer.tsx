...
function WidgetRenderer({ widget }: { widget: EditorWidget }) {
  ...
  // gradient background：write to background directly（background-color does not accept gradients）
  if (isGradient) {
    return (
      <>
...
// memo prevents re-rendering all widgets when the parent re-renders
