...
/**
 * Minimal time template - portrait
 * extra-large clock，only time + date，minimal free layout
 */
const template: EditorTheme = {
  ...
  version: '1.0.0',
  author: '艾联猫',
  description: '超大字体时钟，只有时间+日期，极简free布局',
  source: 'local',
  pages: [
    {
      id: 'p1',
      ...
      widgets: [
        ...
        },
        {
          ...
          content: '「 时间是一切财富中最宝贵财富 」', textAlign: 'center',
        },
      ],
    },
  ],
