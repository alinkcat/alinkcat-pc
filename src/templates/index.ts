...
export interface TemplateDef {
  ...
  description: string;
  /** category: monitor/clock/media/blank/business/game/nature etc. */
  category: string;
  /** template theme data */
  theme: EditorTheme;
}
...
export const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    name: '极简时间',
    description: '超大字体时钟，只有时间+日期，极简 free 布局',
    category: 'clock',
    theme: minimalTime,
  },
  {
...
/**
 * deep-copy template data（avoid shared-reference state bleed）
 */
