...
// cloud service submenu page paths（for auto-expanding the menu）
...
export default function AppSidebar() {
  ...
  // expand the parent menu when on a cloud sub-page（submenu only when logged in）
  useEffect(() => {
  ...
  // cloud submenu: collapse to a single 'login to use' entry（locked state）
